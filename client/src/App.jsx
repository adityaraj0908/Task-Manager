...
function App() {
  ...
  const handleLogin = async () => {
    ...
    } catch (err) { alert("Login Failed. Try 'admin' / 'mypass123'"); }
  };
    ...
    return (
      <div className="h-screen flex justify-center items-center bg-gray-100">
        <div className="bg-white p-8 rounded shadow-lg w-96">
          ...
          <input className="border w-full p-2 mb-4" type="password" placeholder="Password (mypass123)" onChange={e => setCreds({...creds, password: e.target.value})} />
